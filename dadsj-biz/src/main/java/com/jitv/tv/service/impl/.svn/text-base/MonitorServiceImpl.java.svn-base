...
import com.jitv.tv.dto.MonitorInfoDTO;
import com.jitv.tv.service.IMonitorService;
...
public class MonitorServiceImpl implements IMonitorService {
    ...
    public MonitorInfoDTO getMonitorInfoBean() throws Exception {
        int kb = 1024;
        ...
        MonitorInfoDTO infoBean = new MonitorInfoDTO();
    ...
    public static void main(String[] args) throws Exception {
        ...
        MonitorInfoDTO monitorInfo = service.getMonitorInfoBean();

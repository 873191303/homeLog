...
public class ValidCodeUtils {
	...
	public static String getCodeFont() {
		if (CODEFONT == null) {
			...
			Path confPath = Paths.get(System.getProperty("user.dir") + sep + "resource" + sep + "valid_code.font");
	...
	private static String REDIS_CODE_QZ = "rcq_";
...
//				return baseFont.deriveFont(Font.PLAIN, fontHeight);
	...
	public static boolean equalCode(String key, String value) {
		...
		// if(!StringUtil.ise StrUtils.checkParam(redisValue)) {
		// return false;
		// }
